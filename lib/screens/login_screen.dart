...
// await Provider.of<WorkoutProvider>(context, listen: false).loadLatestWorkout(); // ✅ Load user-specific session

//       // await Provider.of<WorkoutProvider>(context, listen: false).loadLatestWorkout(); // ✅ ADD THIS LINE
...
//       await Provider.of<WorkoutProvider>(context, listen: false).loadLatestWorkout();
